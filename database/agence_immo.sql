...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 26 jan. 2024 à 14:40
...
(7, 'Maison villa', 317000, 220, 'Maison', 'Nice, Bord de mer', 'Jolie Villa accès plage depuis la villa avec un grand terrain à l\'ombre le matin', '9391b820f39a47a99d480db752701757.jpg', '2024-01-26 10:14:18');
...
CREATE TABLE IF NOT EXISTS `pending_contact` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_870D11A96F5DA3DE` (`announce_id`),
  UNIQUE KEY `UNIQ_870D11A9A76ED395` (`user_id`)
